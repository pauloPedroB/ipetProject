...
Route::get('/Editar/Loja/{id}', [LojaController::class, 'edit'])->middleware('auth', 'CheckNotType');
...
Route::get('/payment',[LojaController::class, 'premium'])->middleware('auth', 'CheckType','CheckLoja');
