...
Route::get('/produtos/{id}/{prod?}', [ProductsController::class, 'show'])->where('id', '[0-9]{1,2,3}');;
Route::delete('/produtos/{id}', [ProductsController::class, 'destroy'])->middleware('auth', 'CheckLoja')->where('id', '[0-9]{1,2,3}');
