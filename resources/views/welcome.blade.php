...
<body>
    <header>
        ...
        <p class="msg">Houve algum problema no cadastro do seu endereço, cadastre-o novamente. Enquanto isso, continue
            pesquisando por produtos próximos a região de Taboão da Serra</p>
        @endif
        @if (session('msg'))
            ...
            <div class="carousel-inner" data-bs-interval="500">
                ...
                <div class="carousel-item">
                    <img src="/img/pet-care/3828509.jpg" class="img-fluid rounded-4 w-100 d-none d-sm-block ps-5 pe-5"
                        alt="...">
                    <img src="/img/pet-care/3828509-cell.jpg" class="img-fluid  w-100 d-block d-sm-none p-2 m-0"
                        alt="...">
                ...
                <div class="carousel-item">
                    <img src="/img/pet-cools/3906953.jpg" class="img-fluid rounded-4 w-100 d-none d-sm-block ps-5 pe-5"
                        alt="...">
                    <img src="/img/pet-cools/3906953-cell.jpg" class="img-fluid  w-100 d-block d-sm-none p-2 m-0"
                        alt="...">
                </div>
            </div>
