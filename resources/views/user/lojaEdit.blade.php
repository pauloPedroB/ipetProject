...
@section('content')
    ...
    <div id="event-create-container" class="col-md-6 offset-md-3">
        ...
        <form class="d-flex flex-column flex-md-row align-items-baseline w-100 p-2 bs-light-rgb"
            action="/Update/Loja/{{ $registro->id }}" method="POST" enctype="multipart/form-data" id="addres">
            @csrf
            @method('PUT')
            <div class="container-fluid " id="container-register">
                ...
                <div class="form-group">
                    ...
                    @if ($user->AL_id == 2)
                        ...
                        <input class="form-control" type="text" name="cnpj" id="cnpj" class=""
                            placeholder="00.000.000/0000-00" value="{{ $registro->CNPJ }}" disabled>
                        ...
                        <input class="form-control" type="tel" id="celular" name="celular"
                            value="{{ $registro->Celular }}" required>
                    @else
                        <label class="form-label" for="cnpj">CPF:</label>
                        <label for="" id="error-message"></label>
                        <input class="form-control" type="text" name="CPF" id="CPF" class=""
                            value="{{ $registro->CPF }}" placeholder="__.___.___/____-__" disabled>
            ...
            <div class="container-fluid " id="container-register">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="neighborhood" name="neighborhood"
                        placeholder="Seu bairro..." value="" required>
                    ...
                    <select name="uf" id="uf"class="form-control" type="select" value="" required
                        data-input>
                    ...
                    <div class="d-none">
                        ...
                        <input type="text" class="form-control" id="lat" name="lat"
                            placeholder="Sua Latitude..." value="">

                        <label for="title">Latitude</label>
                        <input type="text" class="form-control" id="long" name="long"
                            placeholder="Sua Longitude..." value="">
                    </div>
                </div>
    ...
    <script>
        ...
        form.addEventListener("submit", function(event) {
            ...
            fetch(
                    `https://maps.googleapis.com/maps/api/geocode/json?address=${cepInput.value} ${numberInput.value},${cepInput.value}&key=${api_key}`)
