...
@section('content')
    ...
    <div id="event-create-container" class="col-md-6 offset-md-3 pt-5 pb-5">
        ...
        <form class="d-flex flex-column flex-md-row align-items-baseline w-100 p-2 bs-light-rgb" action="/Cadastrar/Loja"
            method="POST" enctype="multipart/form-data" id="addres">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="d-none">
                        ...
                        <input type="text" class="form-control" id="lat" name="lat"
                            placeholder="Sua Latitude..." disabled>

                        <label class="form-label" for="title">Latitude</label>
                        <input type="text" class="form-control" id="long" name="long"
                            placeholder="Sua Longitude..." disabled>
    ...
    <script>
        ...
        form.addEventListener("submit", function(event) {
            ...
            fetch(
                    `https://maps.googleapis.com/maps/api/geocode/json?address=${cepInput.value} ${numberInput.value},${cep}&key=${api_key}`)
                .then(response => response.json())
                .then(data => {
