    ...
    <div class="row " style="margin: 0">
        ...
        <div class="d-flex flex-row mt-1 flex-wrap justify-content-around">
            ...
            <div class="col-auto card-market flex-column text-center m-5 ">
                <a class="btn" href="/">
                    <div class="rounded-5 p-3" id="card_pacote">
                        ...
                        <p class="fs-6 p-1">Seus produtos aparecerão para os clientes por ordem de proximidade</p>
                    </div>
                </a>
            </div>
            ...
            <div class=" col-auto card-user flex-column  text-center m-5">
                <a class="btn" href="/payment">
                    <div class="rounded-5 p-3" id="card_pacote_premiun">
                        ...
                        <p class="fs-6 p-1" >Seus produtos aparecerão primeiro para os clientes em relação as outras lojas!</p>
                    </div>
                </a>
            </div>
        </div>
