...
@section('content')
    ...
    <div id="event-create-container" class="col-md-6 offset-md-3">
        ...
        <div id="header_form" class="d-flex flex-column flex-md-row align-items-center">
            <i class=" col fa-solid fa-user  d-flex justify-content-center align-items-center m-" id="icon_register"></i>
            <h1 class="fs-2 m-4">Cadastro - Pessoa Física</h1>
        </div>
        <form class="d-flex flex-column flex-md-row align-items-baseline w-100 p-2 bs-light-rgb" action="/Cadastrar/Usuario" method="POST" enctype="multipart/form-data" id="addres">
            @csrf
